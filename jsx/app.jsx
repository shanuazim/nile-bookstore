...
const PRODUCTS = [
    {id: 0, src: 'images/nm_golfCap.jpg', title:'NM Golf Cap', price: 19.99},
    {id: 1, src: 'images/nm_pen.jpg', title:'NM Pen', price:29.99},
    {id: 2, src: 'images/nm_tumbler.jpg', title:'NM Tumbler', price:39.99},
    {id: 3, src: 'images/nm_bag.jpg', title:'NM Bag', price:9.99}
]

const Heading = () => {
    return <h1>Northwestern Mutual Store</h1>
}
